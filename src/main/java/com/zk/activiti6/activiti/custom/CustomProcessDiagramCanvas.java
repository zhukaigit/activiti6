...
public class CustomProcessDiagramCanvas extends DefaultProcessDiagramCanvas {
    ...
    public BufferedImage generateBufferedImage(String imageType) {
        ...
        if (minX >= 0 && minY >= 0) {
            imageToSerialize = processDiagram.getSubimage(minX - WorkflowConstants.PROCESS_PADDING,
                    minY - WorkflowConstants.PROCESS_PADDING, canvasWidth - minX + WorkflowConstants.PROCESS_PADDING,
    ...
    public void initialize(String imageType) {
        ...
        try {
             ...
             * "static/img/activiti/").getPath(); SCRIPTTASK_IMAGE =
             * ImageIO.read(new FileInputStream(baseUrl+"scriptTask.png"));
             * USERTASK_IMAGE = ImageIO.read(new
             ...
             * ImageIO.read(new FileInputStream(baseUrl+"sendTask.png"));
             * MANUALTASK_IMAGE = ImageIO.read(new
             * FileInputStream(baseUrl+"manualTask.png"));
             * BUSINESS_RULE_TASK_IMAGE = ImageIO.read(new
             * FileInputStream(baseUrl+"businessRuleTask.png"));
             * SHELL_TASK_IMAGE = ImageIO.read(new
             * FileInputStream(baseUrl+"shellTask.png")); CAMEL_TASK_IMAGE =
             * ImageIO.read(new FileInputStream(baseUrl+"camelTask.png"));
             * MULE_TASK_IMAGE = ImageIO.read(new
             * FileInputStream(baseUrl+"muleTask.png")); TIMER_IMAGE =
             * ImageIO.read(new FileInputStream(baseUrl+"timer.png"));
             * COMPENSATE_THROW_IMAGE = ImageIO.read(new
             * FileInputStream(baseUrl+"compensate-throw.png"));
             * COMPENSATE_CATCH_IMAGE = ImageIO.read(new
             * FileInputStream(baseUrl+"compensate.png")); ERROR_THROW_IMAGE =
             * ImageIO.read(new FileInputStream(baseUrl+"error-throw.png"));
             * ERROR_CATCH_IMAGE = ImageIO.read(new
             * FileInputStream(baseUrl+"error.png")); MESSAGE_THROW_IMAGE =
             ...
             * SIGNAL_CATCH_IMAGE = ImageIO.read(new
             * FileInputStream(baseUrl+"signal.png"));
             */
            flag = true;
        } catch (IOException e) {
            flag = false;
